...
class LyricAnalyser:
    ...
    def __get_negative_words(self):
        return self.__load_words_from_file(os.path.join(base_dir, 'negative-words.txt'))


    def __get_positive_words(self):
        return self.__load_words_from_file(os.path.join(base_dir, 'positive-words.txt'))
